...
# # Assign a variable for the file to load and the path.
# file_to_load = 'Resources/election_results.csv.csv'
...
#       # OR  Write three counties to the file.
...
# file_to_save = os.path.join("analysis", "election_analysis.txt")
# #Add accumulator. Initialize a total vote counter.
# total_votes = 0
...
# # If candidate_name does not match any existing candidate..
...
#             candidate_options.append(candidate_name)
#             #Beind tracking that candidates's vote count.
